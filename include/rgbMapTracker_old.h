...
public:
    ...
    //New functions for supervoxel segmentation
    SemanticSegmentManager* segment_manager;

        // Add config
    SemanticSegmentConfig semantic_config;

        // Modified rendering with depth-aware transfer
    void threadRenderPointsInVoxelWithSegments(
        voxelHashMap &map, 
